...
local function Init(log, config, elementalEnum)
    ...
    abilityValues["UnleashCharge"].OverchargeName = "Fist of Lumière"
    ...
    abilityValues["PerfectBreak_Gustave"].OverchargeName = "Sword of Lumière"
    ...
    abilityValues["MarkingShot_Gustave"].OverchargeBonusDescription = "Consumes up to " .. (config.MarkingShotChargesConsumed) .. " <keyword id=\"Gustave_Charges\">Charges</> for increased damage.\n" .. "Has a chance of " .. string.format("%g", (config.MarkingShotStunChance) * 100) .. "% to <keyword id=\"StatusEffect_Stunned\">Stun</> the target if all charges are available."
    abilityValues["MarkingShot_Gustave"].OverchargeLongDescription = "Deals low single target " .. GetElementString(config.MarkingShotElement, elementalEnum, false) .. " damage. 1 hit.\n" .. "Applies <keyword id=\"StatusEffect_Mark\">Mark</>\n" .. abilityValues["MarkingShot_Gustave"].OverchargeBonusDescription
    ...
    abilityValues["FromFire_Gustave"].OverchargeName = "Burning Hatred"
    ...
    abilityValues["PerfectRecovery_Gustave"].OverchargeName = "Second Wind"
    ...
    abilityValues["RadiantStrike"].OverchargeName = "Infernal Storm"
    ...
    abilityValues["Overcharge"].OverchargeBonusDescription = "Refills " .. string.format("%g", (config.OverloadChargesPercentage) * 100) .. "% of total <keyword id=\"Gustave_Charges\">Charges</>"
    ...
    abilityValues["SteeledStrike"].OverchargeName = "Rolling Thunder"
    ...
    abilityValues["EndBringer"].OverchargeName = "Final Judgement"
    ...
    abilityValues["Blitz"].OverchargeName = "Sturm"
    ...
    abilityValues["FollowUp"].OverchargeName = "Volt Strike"
    abilityValues["FollowUp"].OverchargeBonusDescription = "Consumes up to " .. (config.FollowUpChargesConsumed) .. " <keyword id=\"Gustave_Charges\">Charges</> for increased damage. Costs " .. (config.FollowUpAPReducedCost) .. " <keyword id=\"APShard\">AP</> if all charges are available."
    ...
    abilityValues["AscendingAssault"].OverchargeName = "Relentless Assault"
    abilityValues["AscendingAssault"].OverchargeBonusDescription = "Consumes up to " .. (config.AscendingAssaultChargesConsumed) .. " <keyword id=\"Gustave_Charges\">Charges</> for increased damage. Costs " .. (config.AscendingAssaultAPReducedCost) .. " <keyword id=\"APShard\">AP</> if all charges are available."
    ...
    abilityValues["SpeedBurst"].OverchargeName = "Lightning Rush"
    ...
    abilityValues["PhantomStars"].OverchargeName = "Absolute Zero"
    abilityValues["PhantomStars"].OverchargeBonusDescription = "Consumes up to " .. (config.PhantomStarsChargesConsumed) .. " <keyword id=\"Gustave_Charges\">Charges</> for increased damage. Costs " .. (config.PhantomStarsAPReducedCost) .. " <keyword id=\"APShard\">AP</> if all charges are available.\n" .. "Can <keyword id=\"Break\">Break</> a target and refill " .. string.format("%g", (config.PhantomStarsChargesPercentage) * 100) .. "% of total <keyword id=\"Gustave_Charges\">Charges</> upon doing so."
    ...
    abilityValues["ParadigmShift"].OverchargeName = "Charge Shift"
    ...
    abilityValues["Purification"].OverchargeName = "Grim Embrace"
